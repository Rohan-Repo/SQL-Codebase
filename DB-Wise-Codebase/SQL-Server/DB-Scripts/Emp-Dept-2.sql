...
SELECT 'What if an employee was transferred to another country' AS UpdateOperation;

-- What if an employee was transferred to another country
...
SELECT 'What if an employee left the company' AS DeleteOperation;
