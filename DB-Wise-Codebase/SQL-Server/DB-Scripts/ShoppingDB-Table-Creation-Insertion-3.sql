...
VALUES
( 'iPhone 15 Pro Max', 2000, 'SmartPhones' );

INSERT INTO Products 
( productName, productPrice, productType )
VALUES
( 'Samsung Galaxy S24', 1700, 'SmartPhones' );

INSERT INTO Products 
( productName, productPrice, productType )
VALUES
( 'Apple Macbook Pro', 5300, 'Laptops' );

INSERT INTO Products 
( productName, productPrice, productType )
VALUES
( 'Lenovo Yoga 7', 1500, 'Laptops' );

INSERT INTO Products 
( productName, productPrice, productType )
VALUES
( 'FitBit Charge 6', 250, 'SmartWatches' );

INSERT INTO Products 
( productName, productPrice, productType )
VALUES
( 'Garmin Instinct', 525, 'SmartWatches' );

INSERT INTO Products 
( productName, productPrice, productType )
VALUES
( 'Apple iPad Air', 800, 'Tablets' );

INSERT INTO Products 
( productName, productPrice, productType )
VALUES
( 'Amazon Fire Tablet', 125, 'Tablets' );

INSERT INTO Products 
( productName, productPrice, productType )
VALUES
( 'Nespresso Vertuo', 175, 'Coffee Machines' );
...
SELECT storeAddress, productName, productType, orderDate, productPrice, orderQuantity, (productPrice * orderQuantity) AS orderAmt, orderTaxAmount, ((productPrice * orderQuantity) + orderTaxAmount) AS totalBillAmt FROM Orders INNER JOIN Products ON Orders.productId = Products.productId ORDER BY totalBillAmt DESC;