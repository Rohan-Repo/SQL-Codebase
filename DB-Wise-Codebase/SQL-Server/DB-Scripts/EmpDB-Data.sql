...
(
	...
	ucUserName VARCHAR(50) NOT NULL,
	ucPassword VARCHAR(50) NOT NULL
);

INSERT INTO UserCredentials 
	( ucUserName, ucPassword )
VALUES
	( 'admin', HASHBYTES( 'SHA1', 'admin' ) )

INSERT INTO UserCredentials 
	( ucUserName, ucPassword )
VALUES
	( 'user', HASHBYTES( 'SHA1', 'user' ) )
...
SELECT CONCAT( empFirstName, ' ', empLastName ) AS empName, CONCAT( empCity, ' , ', empCountry ) AS empLocation, empBirthDate, empHireDate, empJobTitle, empEmailId, empSalary, deptName FROM Employee JOIN Department ON Employee.empDept = Department.deptId ORDER BY empSalary DESC;
